...
export default ({ modalVisible, setModalVisible, setModalTwoVisible }) => {
  const onDeletePress = () => {
      ...
      <CenteredView>
        <ModalView>
          <MenuDeleteTitle>
            ...
            {'\n'}Deleting this project will trigger a refund of all the coins to their owners and
            the startup info will be lost forever
          </MenuDeleteTitle>
          <BottomRow>
            <ButtonOuter
              text="Cansel"
